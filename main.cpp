...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Vec3 start = Transform(segment.origin, viewProjectionMatrix * viewportMatrix);
		Vec3 end = Transform(segment.origin + segment.diff, viewProjectionMatrix * viewportMatrix);
