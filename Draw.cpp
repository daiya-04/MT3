...
void DrawOBB(const OBB& obb, const Matrix44& viewProjectionMatrix, const Matrix44& viewportMatrix, uint32_t color) {
	...
	//左下前
	point[0] = obb.center - oriented[0] - oriented[1] - oriented[2];
	//左下奥
	point[1] = obb.center - oriented[0] - oriented[1] + oriented[2];
	//左上奥
	point[2] = obb.center - oriented[0] + oriented[1] + oriented[2];
	//左上前
	point[3] = obb.center - oriented[0] + oriented[1] - oriented[2];
	//右上奥
	point[4] = obb.center + oriented[0] + oriented[1] + oriented[2];
	//右上前
	point[5] = obb.center + oriented[0] + oriented[1] - oriented[2];
	//右下前
	point[6] = obb.center + oriented[0] - oriented[1] - oriented[2];
	//右下奥
	point[7] = obb.center + oriented[0] - oriented[1] + oriented[2];
