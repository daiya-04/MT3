...
bool IsCollision(const OBB& obb, const Segment& segment) {
	...
	Vec3 localOrigin = Transform(segment.origin, obbWorldMatrix.Inverse());
	Vec3 localEnd = Transform(segment.origin + segment.diff, obbWorldMatrix.Inverse());
...
bool IsCollision(const OBB& obb1, const OBB& obb2) {
	...
	Vec3 separationAxisCandidate[15];
